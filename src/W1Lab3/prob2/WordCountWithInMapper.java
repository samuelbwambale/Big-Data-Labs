...
public class WordCountWithInMapper {

	private List<Mapper> mappers;
	private List<Reducer> reducers;
	private int r;
	private List<List<KeyValue>> reducerKeyValues;

	public WordCountWithInMapper(int r) {
		this.r = r;
	...
	public static void main(String[] args) {
		WordCountWithInMapper wordCount = new WordCountWithInMapper(4);
	...
	public void createMappers() {
		Mapper mapper1 = new Mapper("src/W1Lab3/file1.txt");
		Mapper mapper2 = new Mapper("src/W1Lab3/file2.txt");
		Mapper mapper3 = new Mapper("src/W1Lab3/file3.txt");
		Mapper mapper4 = new Mapper("src/W1Lab3/file4.txt");
		mappers.add(mapper1);
		mappers.add(mapper2);
		mappers.add(mapper3);
		mappers.add(mapper4);
	...
	public void shuffle() {
		...
		for (int j = 0; j < mappers.size(); j++) {
			...
			createKeysPerMapper();
			for (KeyValue<String, List<Integer>> kv : mappers.get(j).getListString()) {
	...
	public void createKeysPerMapper() {
		...
		int i = 0;
		while (i < r) {
			reducerKeyValues.add(new ArrayList<KeyValue>());
			i++;
		}
	}
